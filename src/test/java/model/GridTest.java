...
public class GridTest {
  ...
  public void testCountAliveNeighbours() {
    ...
    grid.getCell(2, 2).setState(CellState.RED_ALIVE);
    grid.getCell(0, 0).setState(CellState.RED_ALIVE);
    assertThat(grid.countAliveNeighbors(1, 1)).isEqualTo(2);
  }

  @Test
  public void testCalculateNextState() {
    grid.getCell(1, 0).setState(CellState.RED_ALIVE);
    grid.getCell(1, 1).setState(CellState.RED_ALIVE);
    grid.getCell(1, 2).setState(CellState.RED_ALIVE);
